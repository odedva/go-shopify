...
type AmountSet struct {
	ShopMoney        MoneySet `json:"shop_money"`
	PresentmentMoney MoneySet `json:"presentment_money"`
}
...
type RefundDuty struct {
	...
	AmountSet struct {
		ShopMoney        MoneySet `json:"shop_money,omitempty"`
		PresentmentMoney MoneySet `json:"presentment_money,omitempty"`
